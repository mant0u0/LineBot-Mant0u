...
def get_jpwords_example_sentences(text):
    ...
    try:
        prompt = [
            ...
            {   
                "Q":"インターネット（を）します。上網", 
                "A":"今から{{インターネットをします}}。大切なメールを確認しなければなりません。\n我現在要{{上網}}了。我必須檢查重要的郵件。"
            },
            {   
                "Q":"気持ちがいい。舒服，心理上生理上舒暢", 
                "A":"この椅子はとても{{気持ちがいい}}です。這張椅子坐起來非常{{舒服}}。"
            },
            {   
                "Q":"幾つ。[① 幾歲，多大, ②（數量）多少個]", 
                "A":"{{幾つ}}になりましたか？\n你{{幾歲}}了？"
            ...
            {   
                "Q":"幾つ。[① 幾歲，多大, ②（數量）多少個]", 
                "A":"この箱には{{幾つ}}のリンゴが入っていますか？\n這個箱子裡有{{多少個}}蘋果？"
            },
            {   
                "Q":"ご主人。尊夫，您的先生：提及別人的先生時用「ご主人」", 
                "A":"私の{{ご主人}}はとても忙しいです。\n我的{{先生}}非常忙。"
            },
        ]
        return_text = geminiPrompt(text, prompt)
